<template>
	<view style="background-color: #e6e6e6; height: 100vh;">
		<view style="display: flex; flex-direction: row; align-items: center; margin-bottom: calc(10rpx * 2);" class="top-block">
			<view>
				<up-image :show-loading="true" style="margin-left: calc(15rpx * 2); margin-right: calc(15rpx * 2);"
					src="../../static/img/logo.png" width="130rpx" height="130rpx" @click="click"
					shape="circle"></up-image>
			</view>
			<view>
				<text style="color: white; font-size: calc(25rpx * 2);">嘎嘎</text>
			</view>
		...
		<view style="">
			<view style="display: flex; justify-content: center;">
				<view class="line-block">
					...
					<view style="border-bottom: 1px solid #ccc; padding: calc(20rpx * 2);">
			...
			<view style="display: flex; justify-content: center; margin-top: calc(15rpx * 2);">
				<view class="line-block">
					<view style="border-bottom: 1px solid #ccc; padding: calc(20rpx * 2);">
